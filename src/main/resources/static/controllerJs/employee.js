...
// employee statuses values
 ...
 /* employeeStatuses = [{id:1,name:'Working'},
    ...
    employeeStatuses = ajaxGetRequest("/emploueeStatus/findAll");
...
const userConfirmMsg = 'Are you sure to add this employe\n'
+'\n Full Name is :'+employee.fullname
+'\n NIC is :'+employee.nic
+'\n E-mail is :'+employee.email
+'\n Employee status is'+empstatus_id.name;

const userConfirm = confirm(userConfirmMsg);
    if(userConfirm){

      //pass datain to backend
